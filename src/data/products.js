...
export const products = [
  ...
  },
  {
    ...
    short: 'Sacola impressa com a sua marca',
    subtitle: 'Impressão flexográfica até 6 cores',
    description:
      'Transforme cada entrega em divulgação ambulante da sua marca. Sacolas personalizadas com impressão flexográfica de alta definição em até 6 cores. Disponíveis em diversos formatos: alça camiseta, alça vazada ou alça soldada. Acabamento brilhante ou fosco.',
    image: '/images/saluz-sacola.png',
    badge: 'Mais vendida',
    icon: Printer,
    color: '#fafafa',
    tags: ['Até 6 cores', 'Logo personalizada', 'Brilho ou fosco', 'Flexografia HD'],
    sizes: [
    ...
    features: [
      { title: 'Impressão HD', text: 'Flexografia com clichês de alta resolução para cores vivas.' },
      { title: 'Até 6 cores', text: 'Imprimimos múltiplas cores no mesmo design — sem custo extra de cor adicional.' },
      { title: 'Brilho ou fosco', text: 'Escolha o acabamento que melhor combina com a sua marca.' },
      { title: 'Sob medida', text: 'Definimos tamanho, espessura e formato exatamente como você precisa.' },
    ],
  ...
  },
  {
    slug: 'sacola-branca',
    title: 'Sacola Branca',
    short: 'Sacola plástica lisa, sem impressão',
    subtitle: 'Modelo econômico sem personalização',
    description:
      'Sacola plástica tipo camiseta branca opaca, lisa, sem impressão. Solução econômica e versátil — ideal para comércio em geral que precisa de embalagem prática sem identidade visual. Produzida em PEAD virgem.',
    image: '/images/sacola2.png',
    badge: 'Econômica',
    icon: ShoppingBag,
    color: '#ffffff',
    tags: ['Sem impressão', 'PEAD virgem', 'Atóxica', 'Alça reforçada', 'Branca opaca'],
    sizes: [
      { name: 'PP', size: '20×30 cm', pack: '1.000 un' },
      { name: 'P', size: '30×40 cm', pack: '1.000 un' },
      { name: 'M', size: '40×50 cm', pack: '500 un' },
    ...
    features: [
      { title: 'Mais econômica', text: 'Sem impressão, é a opção de menor custo por unidade.' },
      { title: 'Pronta entrega', text: 'Estoque permanente nos tamanhos padrão.' },
      { title: 'Atóxica', text: 'Aprovada para contato indireto com alimentos secos.' },
      { title: 'Reciclável', text: 'PEAD 100% reciclável.' },
    ],
    applications: ['Supermercados', 'Mercearias', 'Lojas de variedade', 'Bazares', 'Açougues'],
  },
  {
    slug: 'sacola-verde',
    title: 'Sacola Verde',
